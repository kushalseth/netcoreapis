...
namespace Hmsapp.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            var applicationOperator = new ApplicationOperator { UserName = model.UserName,
        ...
        public ActionResult Registration()
        {
            ...
            {
                return RedirectToAction("Index", "HMS");
            }
            else {
                return View();
            }
        ...
        public async Task<ActionResult> Registration(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationOperator { UserName = model.Email, Email = model.Email };
        ...
        public void CreateClaims(string email)
        {
            var claims = new List<Claim>();
            var userUid = ClaimsPrincipal.Current.Claims.FirstOrDefault(x => x.Type == "name");

            // create required claims
            claims.Add(new Claim("UserEmail", email));
            var identity = new ClaimsIdentity(claims, DefaultAuthenticationTypes.ApplicationCookie);
            //UserManager.AddClaim<ApplicationOperatorManager, "UserEmail">(userUid, claims);
        }
